...
import com.hemajoo.data.common.type.CollectionType;
...
import com.hemajoo.data.persistence.geography.subdivision.Subdivision;
import com.hemajoo.data.persistence.geography.subdivision.SubdivisionType;
import com.hemajoo.data.persistence.metric.Metric;
import com.hemajoo.data.persistence.metric.type.MetricSourceType;
import com.hemajoo.data.persistence.metric.type.MetricType;
import com.hemajoo.data.persistence.metric.type.MetricUnitType;
import com.hemajoo.data.persistence.metric.type.MetricValueType;
import com.hemajoo.data.persistence.series.TimeSeries;
import com.hemajoo.data.persistence.series.TimeSeriesException;
import com.hemajoo.data.persistence.series.TimeSeriesKey;
...
import com.hemajoo.i18n.data.geography.country.CountryException;
...
class CountryTest extends AbstractHemajooUnitTest
{
    @Autowired
...
//    }
    ...
    {
        Country country = countryService.findByIsoAlpha2Code(CountryType.UNITED_STATES.getIsoAlpha2());

        assertThat(country).isNotNull();
        assertThat(country.getIsoAlpha2Code()).isEqualTo(CountryType.UNITED_STATES.getIsoAlpha2());
        assertThat(country.getName()).isEqualTo(CountryType.UNITED_STATES.getName());
    }
